    ...
    return (
        <div className='interactive-container'>
            <div className="map__container">
                <InteractiveMap handleChangeRegion={handleChangeRegion} />
            </div>
            <div>
                <h3>
...
const InteractiveMap = (props) => {
    const { handleChangeRegion } = props;
    return (
        <svg
            id="colombiahigh"
...
const Path = ({ id, d, fill, stroke, strokeWidth, handleChangeRegion }) => {
    ...
    return (
        <motion.g className={'group_region'}>
            ...
            {cantidadProyectos > 0 && <text fontSize={15} fontWeight={700} x={textPosition.x} y={textPosition.y} fill='white' textAnchor='middle' dominantBaseline={'middle'}>
                {cantidadProyectos}
            </text>}
